...
public class DigitClassification {
    ...
    private final int TRAINIMAGES = 5000;//5000; // set low to debug
    ...
    public void runPerceptronGradientDescent() {
        ...
        do {
            ...
            for (int t = 0; t < TRAINIMAGES; t++) {
                ...
                // dot product calculated for all digits...
                for (int r = 0; r < ROW * COLUMN; r++) {
    ...
    public static void main(String[] args) throws IOException {
        String trainImages = "trainingimages1";
        String trainLabels = "traininglabels1";
        String testImages = "testimages1";
        String testLabels = "testlabels1";
